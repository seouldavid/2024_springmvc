...
public class EmpController {
	...
	*/
	//다음 jsp 에 받은 idx를 그대로 넘기기 위해서 => @ModelAttribute("idx")
	@PostMapping("/emp_dynamic_search")
	public ModelAndView emp_dynamic_search(
									@ModelAttribute("idx") String idx, //idx를 동적쿼리 검색을 눌렀을때 넘어온다.
									@RequestParam("keyword") String keyword) { // keyword
		try {
			ModelAndView mv = new ModelAndView("day05/emp_dynamic");
